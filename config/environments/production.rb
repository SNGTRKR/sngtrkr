...
# Code is not reloaded between requests
  ...
  config.assets.precompile += ['rails_admin/rails_admin.css', 'rails_admin/rails_admin.js', 'sidekiq/application.js', 'sidekiq/*.css', 'css3-fallback.js', '*.svg', '*.eot', '*.woff', '*.ttf', '*.otf']
